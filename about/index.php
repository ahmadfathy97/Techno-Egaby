    ...
    <div class="row">
      ...
      <div class="col-md-12 mt-5 py-5 text-center rounded shadow-lg">
        <div class="info">
          ...
          <p> وهي مبادرة من قسم تكنولوجيا التعليم بكلية التربية النوعية بجامعة الفيوم، تهدف لتوظيف أدوات ومحتوى التعليم الإلكتروني لخدمة المجتمع للتوعية ضد فيروس كورونا.</p>
        </div>
        <div class="row team">
