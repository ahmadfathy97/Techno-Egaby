...
if (isset($_SESSION['user'])) {
    ...
    if (isset($_POST['edit'])) {
      ...
      $pass_hash='';
      if (empty($password)) {
          $pass_hash=$user['pass'];//if not write password will be password old
      }else{
      ...
      if (!empty($err)) {
        ...
        echo "<div style='color:#fff'>تم التعديل بنجاح :)</div>";
          ...
          <div class="col-md-12 p-5 shadow">
            <form action="" method="post">
              <div class="form-group">
                ...
                <input name="username" value="<?php if(isset($username)){echo $username;}else{echo $user['user'];}  ?>" type="text" required class="form-control" />
              </div>
              <div class="form-group">
                <label>كلمة السر</label>
                <input name="password" value="<?php if(isset($password)){echo $password;}  ?>" type="password" class="form-control"  />
              </div>
              <div class="form-group">
                <label>تأكيد كلمة السر</label>
                <input name="confirm_password"value="<?php if(isset($confirm_password)){echo $password;}  ?>"  type="password" class="form-control"  />
              </div>
              <div class="form-group">
